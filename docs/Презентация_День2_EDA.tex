...
\dqorig{dfhjxyfz gfytkm} & {варочная панель} \\
\dqorig{dbltjrfvthf} & {видеокамера} \\
\dqorig{le[jdjq irfa} & {духовой шкаф} \\
\dqorig{pfhzlyjt ecnhjqcndj} & {зарядное устройство} \\
\dqorig{rf,tkm rkfdbfnehs} & {кабель клавиатуры} \\
\dqorig{hj,jn gsktcjc} & {робот пылесос} \\
\dqorig{nhbvvth lkz yjcf} & {триммер для носа} \\
\dqorig{cvfhn xfcs} & {смарт часы} \\
\dqorig{cgkbn cbcntvf} & {сплит система} \\
\dqorig{,tujdfz ljhj;rf} & {беговая дорожка} \\
\dqorig{ctntdjq abkmnh} & {сетевой фильтр} \\
\dqorig{cbcntvysq ,kjr} & {системный блок} \\
\dqorig{,tcghjdjlyjq gsktcjc} & {беспроводной пылесос} \\
\dqorig{jxbcnbntkm djple[f} & {очиститель воздуха} \\
\end{tabular}
\column{0.49\textwidth}
\begin{tabular}{@{}L{3.0cm}@{\ }L{3.4cm}@{}}
\dqhead{Ввели (EN)} & \dqhead{Хотели найти}\\[2pt]
