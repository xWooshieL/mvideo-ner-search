...
\newcommand{\dqfix}[1]{{\color{mvred}\footnotesize$\to$\,}{\InterSemi\color{mvdark}#1}}
...
\vspace{7pt}\par
{\fontsize{6.6}{8.6}\selectfont\setlength{\tabcolsep}{5pt}\renewcommand{\arraystretch}{1.28}
\begin{columns}[T]
\column{0.49\textwidth}
\begin{tabular}{@{}L{3.0cm}@{\ }L{3.4cm}@{}}
\dqhead{Ввёл (EN)} & \dqhead{Хотел найти}\\[2pt]
\dqorig{lkz djkjc aty gkjqrf gkjqrf} & \dqfix{для волос фен плойка плойка} \\
\dqorig{pfhzlyst ecnhjqcndf lkz frrevekjnjhjd fdnj} & \dqfix{зарядные устройства для аккумулоторов авто} \\
\dqorig{dfhjxyfz gfytkm ,tkjt cntrkh} & \dqfix{варочная панель белое стеклр} \\
\dqorig{dbltjrfvthf lkz gjvtotybz} & \dqfix{видеокамера для помещения} \\
\dqorig{dcnhfbdftvfz cnbhfkmyfz vfibyf} & \dqfix{встраиваемая стиральная машина} \\
\dqorig{le[jdjq irfa 'ktrnhbxtcrbq} & \dqfix{духовой шкаф электрический} \\
\dqorig{pfhzlyjt ecnhjqcndj czjvb} & \dqfix{зарядное устройство сяоми} \\
\dqorig{rf,tkm lkz rkfdbfnehs} & \dqfix{кабель для клавиатуры} \\
\dqorig{gsktcjc dthnbrfkmysq ghjdjlyjq} & \dqfix{пылесос вертикальный проводной} \\
\dqorig{nhbvvth lkz yjcf} & \dqfix{триммер для носа} \\
\dqorig{'ktrnhbxtcrfz gkbnf akfvf} & \dqfix{электрическая плита флама} \\
\dqorig{,tujdfz ljhj;rf} & \dqfix{беговая дорожка} \\
\dqorig{,tcghjdjlyjq gsktcjc} & \dqfix{беспроводной пылесос} \\
\dqorig{dfhjxyfz gfytkm} & \dqfix{варочная панель} \\
\end{tabular}
\column{0.49\textwidth}
\begin{tabular}{@{}L{3.0cm}@{\ }L{3.4cm}@{}}
\dqhead{Ввёл (EN)} & \dqhead{Хотел найти}\\[2pt]
\dqorig{dtynbkznjh yfcnjkmysq} & \dqfix{вентилятор настольный} \\
\dqorig{dthnbrfkmysq gsktcjc} & \dqfix{вертикальный пылесос} \\
\dqorig{dcnhfbbdftvsq [jkjlbkmybr} & \dqfix{встраииваемый холодильник} \\
\dqorig{dcnhjtyyfz gjceljvjqrf} & \dqfix{встроенная посудомойка} \\
\dqorig{dcnhjtyysq [jkjlbkmybr} & \dqfix{встроенный холодильник} \\
\dqorig{ufpjdfz gkbnf} & \dqfix{газовая плита} \\
\dqorig{ufqrjdthn htldthu} & \dqfix{гайковерт редверг} \\
\dqorig{ukflbkmyfz ljcrf} & \dqfix{гладильная доска} \\
\dqorig{lhtkm ,eh} & \dqfix{дрель бур} \\
\dqorig{pfdfhjxysq xfqybr} & \dqfix{заварочный чайник} \\
\dqorig{pfhzlyjt ecnhjqcndj} & \dqfix{зарядное устройство} \\
\dqorig{buhjdjt rhtckj} & \dqfix{игровое кресло} \\
\dqorig{buhjdjq hekm} & \dqfix{игровой руль} \\
\dqorig{rkfdbfnehf ,tkfz} & \dqfix{клавиатура белая} \\
\end{tabular}
\end{columns}}
\vspace{5pt}\par
