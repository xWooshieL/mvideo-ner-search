...
\conclusion{Метрики на серебряных метках оптимистичны — это ориентир, а не финальная оценка. Нужен золотой набор 200--500 запросов, размеченный вручную.}
\vspace{8pt}\par
\begin{columns}[T]
...
\end{tabular}}
\vspace{5pt}\par
\tnote{Первым делом спрашивают про риски — не прячем их, показываем вместе с мерами снижения.}
\slidefoot
\end{frame}
