...
\begin{columns}[T]
\column{0.5\textwidth}
\vspace{2pt}\centering\includegraphics[width=0.98\textwidth]{01_query_length_dist.png}\par\vspace{4pt}
\centering\includegraphics[width=0.98\textwidth]{02_top_queries.png}
\column{0.47\textwidth}
...
\begin{columns}[T]
\column{0.5\textwidth}
\vspace{2pt}\centering\includegraphics[width=0.98\textwidth]{05_position_distribution.png}\par\vspace{4pt}
\centering\includegraphics[width=0.98\textwidth]{15_position_click_share.png}
\column{0.47\textwidth}
