...
ApplicationWindow {
    ...
    // на некоторых DPI/мониторах. showMaximized()/showNormal() отдаём ОС — это надёжно
    // работает всегда, а плавность добавляем той же fade-анимацией, что и у сворачивания.
