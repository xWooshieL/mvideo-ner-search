...
QtObject {
    ...
    // Segoe есть только на Windows; на macOS/Linux — системный шрифт
    ...
    // иконки шапки/сайдбара: MDL2 только на Windows, иначе обычный Unicode
    ...
    readonly property string iconSearch:   isWindows ? "\uE721" : "\u2315"
    readonly property string iconStats:    isWindows ? "\uE9D9" : "\u25A6"
    readonly property string iconSettings: isWindows ? "\uE713" : "\u2699"
